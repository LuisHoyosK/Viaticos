...
- comisionados: lista de personas. Por cada persona:
  ...
  - municipios_destino: lista de municipios destino, (si dice MUNICIPIO - lA CORDOBA reemplazalo por LA APARTADA) agrega abreviación por contracción, consonantes representativas de cada municipio.
